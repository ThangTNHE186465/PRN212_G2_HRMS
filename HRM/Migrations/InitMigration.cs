    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Departme__3214EC07B82FEBF2", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__3214EC07E25E1225", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Activity__3214EC07F1A3E283", x => x.Id);
                    table.ForeignKey(
                        name: "FK__ActivityL__UserI__59FA5E80",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Employee__3214EC07F3E17BB3", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Employees__UserI__44FF419A",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notifica__3214EC0757A9EF61", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Notificat__Depar__5629CD9C",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Notificat__Recei__5535A963",
                        column: x => x.ReceiverUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Notificat__Sende__5441852A",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Attendan__3214EC0763B8F39C", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Attendanc__Emplo__4BAC3F29",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Leaves__3214EC078A1E8ECA", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Leaves__Approved__4F7CD00D",
                        column: x => x.ApprovedBy,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Leaves__Employee__4E88ABD4",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Salaries__3214EC07FC2CD556", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Salaries__Employ__48CFD27E",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Employee__A9D10534D9F8FBF8",
                table: "Employees",
                column: "Email",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__536C85E4663AEF39",
                table: "Users",
                column: "Username",
                unique: true);
        }
